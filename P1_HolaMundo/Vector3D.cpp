...
//}
//
//Vector3D Vector3D :: operator+(const Vector3D& vector) { return this->Add(vector); }
//Vector3D Vector3D :: operator-(const Vector3D& vector) { return this->Substract(vector); }
//Vector3D Vector3D :: operator*(const float& value) { return this->Product(value); }
//Vector3D Vector3D :: operator/(const float& value) { return this->Division(value); }
//float Vector3D :: operator*(const Vector3D& vector) { return this->DotProduct(vector); }
